...
- **Sovereign-actor protocol v0** (`0bc`, M1–M5) — M1–M3 built;
  **M4 spawn: designed (ADR-0008/0009 Proposed), M4.1 built
  2026-09-23** (`protocol/spawn`); `0bc.4.2` next, gated on `6sax`;
  talos wire unchanged throughout. State and history
