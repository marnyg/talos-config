...
- **Sovereign-actor protocol v0** (`0bc`, M1–M5) — M1–M3 built;
  **M4 spawn: designed (ADR-0008/0009 Proposed), M4.1 + M4.2 built
  2026-09-23** (`protocol/spawn`, `protocol/provisioner`) — the
  protocol half is complete; `0bc.4.3/.4` (k8s, docker drivers)
  next, outside `protocol/`; talos wire unchanged throughout. State and history
